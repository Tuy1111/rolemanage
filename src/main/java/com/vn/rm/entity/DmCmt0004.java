...
@JmixEntity
@Table(name = "DM_CMT_0004")
@Entity(name = "dmcmt0004")
public class DmCmt0004 {
    ...
    @Column(name = "LOAI_KHOAN")
    private Integer loaiKhoan;
    ...
    public Integer getLoaiKhoan() { return loaiKhoan; }
    public void setLoaiKhoan(Integer loaiKhoan) { this.loaiKhoan = loaiKhoan; }
