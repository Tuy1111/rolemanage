...
@JmixEntity
@Table(name = "DM_QTCNNNNS_0018")
@Entity(name = "dmqtcnnnns0018")
public class DmQtcnnnns0018 {
    ...
    public String getDvctMa() { return dvctMa; }
    public void setDvctMa(String dvctMa) { this.dvctMa = dvctMa; }
