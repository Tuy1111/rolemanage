...
@JmixEntity
@Entity
@Table(name = "DM_TIGIA_0013")

public class DmTigia0013 {
    ...
    @Column(name = "MA_NGOAI_TE", length = 10)
    private String maNgoaiTe;

    @Column(name = "NGAY", length = 8)
    private String ngay; // YYYYMMDD

    @Column(name = "THANG", length = 6)
    private String thang; // YYYYMM

    @Column(name = "LOAI", length = 5)
    private String loai;

    @Column(name = "TY_GIA", length = 20)
